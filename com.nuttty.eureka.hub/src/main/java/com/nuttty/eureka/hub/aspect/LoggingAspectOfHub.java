package com.nuttty.eureka.hub.aspect;
...
public class LoggingAspectOfHub {
    ...
    @Pointcut("execution(* com.nuttty.eureka.hub.presestation.controller.HubController..*(..)) || execution(* com.nuttty.eureka.hub.application.service.HubService..*(..))")
